...
- [在线访问](http://zhengjing1124.github.io/vue-element-admin)
...
**本项目的定位是后台集成方案，不适合当基础模板来开发。**
 - 模板建议使用: [vueAdmin-template](https://github.com/zhengjing1124/vueAdmin-template)  
 - 桌面端: [electron-vue-admin](https://github.com/zhengjing1124/electron-vue-admin)
